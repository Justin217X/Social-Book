...
const SignUp = () => {
    ...
    //     const res = await fetch('localhost:9000/register', {
    //          method: 'POST',
    //          body: {
    //              name: 'User1'
    //          }
                ...
                <div className='signup'>
                    <div className='registerbox'>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <button type="submit" className='signupBtn' disabled={!validName || !validPwd || !validMatch ? true : false}>Register</button>
                        </form>
                        <div>
                            <a href="/login" className='loginlink'>Login Instead</a>
                        </div>
                    </div>
                </div>
            </>
